				...
				<form
							...
							<FormItem>
								<Tabs
									...
									<TabsList className="mb-2">
										<TabsTrigger value="roo">Alchemi Code Cloud</TabsTrigger>
					...
					{provider === "roo" && (
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel>Alchemi Code Cloud Token</FormLabel>
									<FormControl>
										<Input type="password" {...field} />
									</FormControl>
									<FormMessage />
									<FormDescription>
										If you have access to the Alchemi Code Cloud repository then you can generate a
										token with:
										<br />
